...
func BenchmarkHandler(b *testing.B) {
	...
	for _, tblc := range []struct {
		...
		b.Run("buffered-"+tblc.name, func(b *testing.B) {
			hdlr := clservev3.ServeFunc(func(ctx *clservev3.Context[struct{}], w clservev3.ResponseWriter, r *http.Request) error {
				tblc.hf(w, r)
...
var _ = Describe("handle implementations", func() {
	It("should return usual response on success", func(ctx context.Context) {
		...
		clservev3.ServeFunc[struct{}](func(ctx *clservev3.Context[struct{}], w clservev3.ResponseWriter, r *http.Request) error {
	...
	It("error on writing to limit buffer", func(ctx context.Context) {
		resp, req := httptest.NewRecorder(), httptest.NewRequest(http.MethodGet, "/", nil)
		var errIsFull bool
		clservev3.ServeFunc(func(ctx *clservev3.Context[struct{}], w clservev3.ResponseWriter, r *http.Request) error {
			_, err := fmt.Fprintf(w, "xy")
			errIsFull = errors.Is(err, clservev3.ErrBufferFull)

			return nil
		}, clservev3.WithBufferLimit(1)).ServeHTTP(resp, req)
	...
	It("should log unhandled errors by default", func(ctx context.Context) {
		...
		clservev3.ServeFunc[struct{}](func(ctx *clservev3.Context[struct{}], w clservev3.ResponseWriter, r *http.Request) error {
			return errSome
		}, clservev3.WithErrorLog(logs)).ServeHTTP(resp, req)
	...
	It("should handle flushing error", func(ctx context.Context) {
		...
		clservev3.ServeFunc[struct{}](func(ctx *clservev3.Context[struct{}], w clservev3.ResponseWriter, r *http.Request) error {
			...
			return nil
		}, clservev3.WithErrorLog(logs)).ServeHTTP(fresp, req)
